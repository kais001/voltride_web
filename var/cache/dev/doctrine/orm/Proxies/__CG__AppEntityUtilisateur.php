...
class Utilisateur extends \App\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'id_u', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'cin', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'motDePasse', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'dateInscription', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'image'];
        }
    ...
    public function getId_u(): ?int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getId_u();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getId_u', []);

        return parent::getId_u();
    }
