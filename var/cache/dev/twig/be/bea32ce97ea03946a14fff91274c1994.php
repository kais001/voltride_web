...
class __TwigTemplate_4b4b8ca231ad53fb86d5a273099d83ff extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 2
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 2, $this->source); })()), "departement", [], "any", false, false, false, 2), 'row');
        echo "
...
{{ form_end(form) }}
", "admin/_form.html.twig", "C:\\Users\\Kais\\Desktop\\backupweb\\pidev_web\\templates\\admin\\_form.html.twig");
    }
}
