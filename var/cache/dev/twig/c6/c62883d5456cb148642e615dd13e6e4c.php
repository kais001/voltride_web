...
/* admin/new.html.twig */
class __TwigTemplate_4206b377852f5707c43f2708da84beef extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"white-frame\">
        ...
        echo "
            ...
            <div style=\"margin-bottom: 10px;\">
                ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "utilisateur", [], "any", false, false, false, 13), 'row');
        echo " ";
        // line 14
        echo "            </div>
            ...
            <div style=\"margin-bottom: 10px;\">
                ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 17, $this->source); })()), "departement", [], "any", false, false, false, 17), 'row');
        echo " ";
        // line 18
        echo "            </div>
...
";
    ...
    {
        return array (  121 => 23,  116 => 21,  111 => 18,  108 => 17,  103 => 14,  100 => 13,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"main-container\">
    <div class=\"white-frame\">
        <div class=\"content\">
            ...
            <div style=\"margin-bottom: 10px;\">
                {{ form_row(form.utilisateur) }} {# Affichage du formulaire de l'utilisateur #}
            </div>
            
            <div style=\"margin-bottom: 10px;\">
                {{ form_row(form.departement) }} {# Affichage du champ département #}
            </div>
            
            <button type=\"submit\" class=\"btn btn-primary\">Save</button>
            <a href=\"{{ path('app_admin_index') }}\" class=\"btn btn-secondary\">Back to list</a>
...
{% endblock %}
", "admin/new.html.twig", "C:\\Users\\Kais\\Desktop\\backupweb\\pidev_web\\templates\\admin\\new.html.twig");
    }
}
