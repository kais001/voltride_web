...
class __TwigTemplate_387bcea2f66f7cb93553cb806de5f906 extends Template
{
    private $source;
    private $macros = [];
    ...
    <dl class=\"row\">
        ...
        <dd class=\"col-sm-9\">";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 10, $this->source); })()), "departement", [], "any", false, false, false, 10), "html", null, true);
        echo "</dd>
    </dl>

    <a href=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_edit", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 13, $this->source); })()), "utilisateur", [], "any", false, false, false, 13), "id_u", [], "any", false, false, false, 13)]), "html", null, true);
        echo "\">Edit</a>

    <form action=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_delete", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 15, $this->source); })()), "utilisateur", [], "any", false, false, false, 15), "id_u", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\" method=\"post\">
        ";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 16, $this->source); })()), "utilisateur", [], "any", false, false, false, 16), "id_u", [], "any", false, false, false, 16))), "html", null, true);
        echo "
...
";
    ...
    {
        return array (  116 => 20,  109 => 16,  105 => 15,  100 => 13,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <dl class=\"row\">
        <dt class=\"col-sm-3\">Departement:</dt>
        <dd class=\"col-sm-9\">{{ admin.departement }}</dd>
    </dl>

    <a href=\"{{ path('app_admin_edit', {'id': admin.utilisateur.id_u}) }}\">Edit</a>

    <form action=\"{{ path('app_admin_delete', {'id': admin.utilisateur.id_u}) }}\" method=\"post\">
...
{% endblock %}
", "admin/show.html.twig", "C:\\Users\\Kais\\Desktop\\backupweb\\pidev_web\\templates\\admin\\show.html.twig");
    }
}
